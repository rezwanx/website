    ...
    <div className="banner-area-wrapper">
      ...
      <div className="banner-area">
        ...
        <div className="banner-title">
          <h1>
            Unlock your <br /> <span>Business</span> website.
          </h1>
        </div>
          ...
          <div className="row">
            <div className="col-lg-5">
              <p>
                ...
                doloroei. aptent taciti sociosqu ad litora torquent per conubia
                nostra, persento Donec lacinia placerat felis non aliquam.
              </p>
